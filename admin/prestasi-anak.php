      ...
      <div class="col-md-12">
        ...
        <div class="card">
          ...
          <div class="card-body ">
            ...
            ?>
                <tr>
                  <th colspan="3">Data Prestasi Yang Telah Dilakukan Siswa:</th>
                </tr>
                <tr>
...
mysqli_free_result($query);?>
            ...
            <table id="example2" class="table table-bordered table-striped display nowrap" style="width:100%">
              ...
              <tbody>
                <?php
            $nomor_urut = 1;
            $query = $koneksi->query("SELECT * FROM tb_prestasi 
            JOIN tb_siswa ON tb_prestasi.student_id = tb_siswa.id 
            JOIN tb_kelas ON tb_prestasi.class_id = tb_kelas.id_kelas 
            JOIN tb_guru ON tb_kelas.wali_name = tb_guru.id
            WHERE tb_siswa.id = '$id_student'
            ");
            foreach ($query as $data) : 
            ?>
                <tr>
                  ...
                  <td>
                    <?php echo "<a  class='btn btn-sm btn-info' href='#Prestasidetail' class='btn btn-default btn-small' id='custId' data-toggle='modal' data-id=" . $data['id_prestasi']. ">Detail</a>"; ?>
                  </td>
                </tr>
                <?php
$nomor_urut++;
