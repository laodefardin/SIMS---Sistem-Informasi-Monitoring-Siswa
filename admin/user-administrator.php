  ...
  ?>
        <div class="card card-outline card-danger">
          <div class="card-header">
            ...
            <a data-id="Add Pengguna" href='#UserAdd' class='btn btn-sm btn-outline-danger float-right' id='custId'
          ...
          <div class="card-body">
            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                <?php
                $nomor_urut = 1;
                $query = $koneksi->query("SELECT * FROM tb_pengguna WHERE level = 'Administrator' ");
      ...
      <div class="modal fadee" id="UserAdd" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        style="display: none;" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
          <div class="fetched-dataedit" style="width: 100%; height: 400px;"></div>
        </div>
