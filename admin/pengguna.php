    ...
    <div class="row">
      ...
      <div class="col-lg-6">
        <div class="card-body">
          ...
          <a href='pengguna' class="btn btn-danger btn-sm">Refresh</i></a>
        </div>
      </div>
    </div>
    </form>
            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                if (isset($_POST['qcari'])){
                  $qcari = $_POST['qcari'];
                  $query =  $koneksi->query("SELECT * FROM tb_pengguna JOIN tb_siswa ON tb_pengguna.student_id = tb_siswa.id JOIN tb_kelas ON tb_pengguna.class_id = tb_kelas.id_kelas WHERE tb_kelas.id_kelas = '$qcari' ");
                }
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a href="pengguna-hapus?id=<?= $data['id']; ?>"
